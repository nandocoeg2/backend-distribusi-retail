...
describe('SupplierService', () => {
  ...
  describe('getSupplierById', () => {
    it('should return a supplier by id', async () => {
      const supplierId = '1';
      const expectedSupplier = { id: supplierId, name: 'Supplier A', email: 'contact@suppliera.com', address: '456 Corp Ave', phoneNumber: '1122334455', createdAt: new Date(), updatedAt: new Date() };
  ...
  describe('updateSupplier', () => {
    it('should update a supplier', async () => {
      ...
      const expectedSupplier = { id: supplierId, name: 'Supplier A Updated', email: 'contact@suppliera.com', address: '456 Corp Ave', phoneNumber: '1122334455', createdAt: new Date(), updatedAt: new Date() };
